...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		if(isset($_GET['page'])) {
			...
			elseif($page == "antrian") {
				include 'antrian.php';
			} elseif($page == "tambah_antrian") {
				include 'tambah_antrian.php';
			} elseif($page == "nama_pasien") {
				include 'nama_pasien.php';
			} elseif($page == "tambah_antrianproses") {
				include 'tambah_antrianproses.php';
			} elseif($page == "edit_antrian") {
				include 'edit_antrian.php';
			} elseif($page == "edit_antrianproses") {
